...
func getFlagVariables() *FlagVariables {
	...
	flag.StringVar(&flagVariables.netboxURL, "netbox-url", "https://netbox.global.cloud.sap", "The URL of the NetBox instance to connect to. If not set, the default value will be used.")
