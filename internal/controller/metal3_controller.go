...
func NewMetal3Reconciler(k8sClient client.Client, scheme *runtime.Scheme, credentials *credentials.Credentials, netBox netbox.Netbox, reconcileInterval time.Duration) *Metal3Reconciler {
