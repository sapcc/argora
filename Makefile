...
goimports: FORCE
	...
	@goimports -w -local https://github.com/sapcc/argora internal/ $(patsubst $(shell awk '$$1 == "module" {print $$2}' go.mod)%,.%/*.go,$(shell go list ./...))
